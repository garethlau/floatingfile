...
const features = [
	...
	},
	{
		...
		title: "No Accounts",
		body: "No accounts means you can use floatingfile to the fullest on any device, any where.",
	},
	{
	...
	},
	{
		icon: mdiSpeedometer,
		title: "Fast",
		body: "Join with a 6 character code or by scanning a QR code. Reduce your file transfer workflow to seconds.",
	},
];
