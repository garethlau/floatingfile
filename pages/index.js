					...
					>
						<div style={{ textAlign: "center", marginTop: "30px" }}>
							<picture>
								...
								<img className={styles.landingImg} src="/images/space-ui.png" alt="Home" />
							</picture>
						</div>

						<div style={{ textAlign: "center", marginTop: "30px" }}>
							<picture>
								<img className={styles.landingImgMobile} src="/images/space-ui-mobile.png" alt="Home" />
							</picture>
						</div>
					</motion.div>
				</div>
				...
				<div style={{ backgroundColor: "#f1f3f9", padding: "10px 0" }}>
					<Container>
						<div style={{ textAlign: "center" }}>
							...
							<p style={{ maxWidth: "550px", margin: "auto", padding: "0 20px" }}>
								floatingfile is a file sharing platform that marries the flexibility of file storage with the
								convenience of file transfer applications.
							</p>
						</div>
					</Container>
					<EnterInView>
				...
				<div style={{ backgroundColor: "#34448E" }}>
					<Container>
						<div className={styles.mobileBanner}>
							<Center>
								<h2 style={{ color: "white" }}>Get floatingfile for your mobile device</h2>
							</Center>
