...
const apis = [
	...
	{
		method: "DELETE",
		summary: "Deletes a space. This endpoint emits a socket event to notify clients that the space has been destroyed.",
		endpoint: "/api/v3/space/{code}",
		request: {
	...
	},
	{
		...
		request: {
			...
			queryParameters: [{ name: "files", description: "Array of file IDs to be deleted and removed from the space." }],
			body: null,
		},
		responses: [
	...
	},
	{
		...
		request: {
			...
			queryParameters: [{ name: "files", description: "List of file IDs to be zipped and downloaded." }],
			body: null,
		},
	...
	},
	{
		...
		request: {
			pathParameters: [
				{ name: "code", description: "Code of the space to which the files belong." },
		...
		responses: [
			{ status: 200, description: "Operation successful. File stream started." },
			{ status: 400, description: "Invalid request. Missing file ID." },
			{ status: 404, description: "File not found.", message: "File not found." },
			{ status: 404, description: "Space not found.", message: "Space not found." },
			response500,
		],
	},
	{
